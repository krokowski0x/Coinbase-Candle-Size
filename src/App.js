	...
	render() {
		...
		return (
			<div className="App">
				<main>
					<label>
						<Toggle checked={candleSize} onChange={this.toggleCandleSize} />
						<span>Candle Size</span>
					</label>
					<label>
						<Toggle defaultChecked={false} disabled={true} />
						<span className="disabled">Clear Method Candles</span>
					</label>
					<label>
						<Toggle defaultChecked={false} disabled={true} />
						<span className="disabled">Volume Coloring</span>
					</label>
				</main>
				<footer>
					<span>See more of my work at</span>
					<a href="https://github.com/krokowski0x">
						<svg role="img" fill="white" viewBox="0 0 24 24">
